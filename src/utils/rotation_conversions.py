...
def rotation_converter(rot: torch.Tensor, from_type: str, to_type: str) -> torch.Tensor:
    if from_type == to_type:
        return rot
    if from_type == "quat" and to_type == "matrix":
        return quaternion_to_matrix(rot)
    elif from_type == "matrix" and to_type == "quat":
        return matrix_to_quaternion(rot)
    elif from_type == "axis_angle" and to_type == "matrix":
        return axis_angle_to_matrix(rot)
    elif from_type == "matrix" and to_type == "axis_angle":
        return matrix_to_axis_angle(rot)
    elif from_type == "axis_angle" and to_type == "quat":
        return axis_angle_to_quaternion(rot)
    elif from_type == "quat" and to_type == "axis_angle":
        return quaternion_to_axis_angle(rot)
    elif from_type == "axis_angle" and to_type == "rotation_6d":
        return axis_angle_to_rotation_6d(rot)
    elif from_type == "rotation_6d" and to_type == "axis_angle":
        return rotation_6d_to_axis_angle(rot)
    elif from_type == "rotation_6d" and to_type == "matrix":
        return rotation_6d_to_matrix(rot)
    elif from_type == "matrix" and to_type == "rotation_6d":
        return matrix_to_rotation_6d(rot)
    else:
        raise ValueError(f"Invalid rotation type: {from_type} to {to_type}")
...
def matrix_to_rotation_6d(matrix: torch.Tensor) -> torch.Tensor:
    ...
    return matrix[..., :2].clone().transpose(-1, -2).reshape(batch_dim + (6,))
